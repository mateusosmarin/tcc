...
class FIRLeastSquares(Gtk.VBox):
    def __init__(self):
    ...
    def params(self):
        ...
        desired = (desired[0], *desired, desired[-1])
...
if __name__ == '__main__':
    ...
    vbox.pack_start(firls, expand=False, fill=True, padding=0)
